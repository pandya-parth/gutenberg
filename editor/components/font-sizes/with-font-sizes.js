 ...
 */
import { find, reduce, some, upperFirst } from 'lodash';
			...
			( WrappedComponent ) => {
				return class extends Component {
					...
					static getDerivedStateFromProps( { attributes, fontSizes }, previousState ) {
						...
						return reduce( fontSizeAttributeNames, ( newState, customFontSizeAttributeName, fontSizeAttributeName ) => {
							if ( ! didAttributesChange( customFontSizeAttributeName, fontSizeAttributeName ) ) {
								newState[ fontSizeAttributeName ] = previousState[ fontSizeAttributeName ];
								return newState;
							}
